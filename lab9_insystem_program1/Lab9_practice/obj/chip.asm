...
;	./src/chip.c:85: delay_10us();
	...
	push	ar5
	lcall	_delay_10us
;	./src/chip.c:87: SPI_SCK = 1;
;	assignBit
	setb	_P0_2
;	./src/chip.c:88: delay_10us();
	lcall	_delay_10us
	pop	ar5
	pop	ar6
	pop	ar7
;	./src/chip.c:90: spi_r_buf <<= 1;
	mov	ar4,r6
	mov	a,r4
	add	a,r4
	mov	r4,a
;	./src/chip.c:91: spi_r_buf = (SPI_MISO == 1) ? (spi_r_buf | 0x01) : spi_r_buf;
	jnb	_P0_1,00106$
	mov	a,#0x01
	orl	a,r4
	mov	r3,a
...
00107$:
	mov	ar6,r3
;	./src/chip.c:93: SPI_SCK = 0;
;	assignBit
	clr	_P0_2
;	./src/chip.c:94: delay_10us();
	push	ar7
	push	ar6
	push	ar5
	lcall	_delay_10us
...
00133$:
	jc	00102$
;	./src/chip.c:97: return spi_r_buf;
	mov	dpl,r6
;	./src/chip.c:98: }
	ret
	.area CSEG    (CODE)
