...
STEP8:
	DJNZ	R7,STEP8
	RET
;	./src/delay_func.c:119: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'Delay_So'
;------------------------------------------------------------
;	./src/delay_func.c:121: void Delay_So(void) {
;	-----------------------------------------
;	 function Delay_So
;	-----------------------------------------
_Delay_So:
;	./src/delay_func.c:150: __endasm;
DELAY_SO:
	MOV	R6,#10
DELAY_SO_DL1:
	MOV	R7,#12
...
STEP10:
	DJNZ	R7,STEP10
	RET
;	./src/delay_func.c:151: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'Delay_La'
;------------------------------------------------------------
;	./src/delay_func.c:153: void Delay_La(void) {
;	-----------------------------------------
;	 function Delay_La
;	-----------------------------------------
_Delay_La:
;	./src/delay_func.c:182: __endasm;
DELAY_LA:
	MOV	R6,#10
DELAY_LA_DL1:
	MOV	R7,#11
...
STEP12:
	DJNZ	R7,STEP12
	RET
;	./src/delay_func.c:183: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'Delay_Si'
;------------------------------------------------------------
;	./src/delay_func.c:185: void Delay_Si(void) {
;	-----------------------------------------
;	 function Delay_Si
;	-----------------------------------------
_Delay_Si:
;	./src/delay_func.c:214: __endasm;
DELAY_SI:
	MOV	R6,#10
DELAY_SI_DL1:
	MOV	R7,#9
