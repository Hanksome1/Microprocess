      ...
      00032C                        301 _sendbyte:
                           ...
                           000001   308 	ar1 = 0x01
                           000000   309 	ar0 = 0x00
      00032C AF 82            [24]  310 	mov	r7,dpl
                                    311 ;	./src/seven_segment.c:7: for (i=0; i<8; i++)
      00032E 7E 00            [12]  312 	mov	r6,#0x00
      000330                        313 00103$:
                                    314 ;	./src/seven_segment.c:9: CLK = 0;
                                    315 ;	assignBit
      000330 C2 A0            [12]  316 	clr	_P2_0
                                    317 ;	./src/seven_segment.c:10: DIN = (address & 0x80);
      000332 EF               [12]  318 	mov	a,r7
      000333 23               [12]  319 	rl	a
      000334 54 01            [12]  320 	anl	a,#0x01
                                    321 ;	assignBit
      000336 24 FF            [12]  322 	add	a,#0xff
      000338 92 A1            [24]  323 	mov	_P2_1,c
                                    324 ;	./src/seven_segment.c:11: address <<= 1;
      00033A 8F 05            [24]  325 	mov	ar5,r7
      00033C ED               [12]  326 	mov	a,r5
      00033D 2D               [12]  327 	add	a,r5
      00033E FF               [12]  328 	mov	r7,a
                                    329 ;	./src/seven_segment.c:12: CLK = 1;
                                    330 ;	assignBit
      00033F D2 A0            [12]  331 	setb	_P2_0
                                    332 ;	./src/seven_segment.c:7: for (i=0; i<8; i++)
      000341 0E               [12]  333 	inc	r6
      000342 BE 08 00         [24]  334 	cjne	r6,#0x08,00129$
      000345                        335 00129$:
      000345 40 E9            [24]  336 	jc	00103$
                                    337 ;	./src/seven_segment.c:15: for (i=0; i<8; i++)
      000347 7F 00            [12]  338 	mov	r7,#0x00
      000349                        339 00105$:
                                    340 ;	./src/seven_segment.c:17: CLK = 0;
                                    341 ;	assignBit
      000349 C2 A0            [12]  342 	clr	_P2_0
                                    343 ;	./src/seven_segment.c:18: DIN = (dat & 0x80);
      00034B E5 23            [12]  344 	mov	a,_sendbyte_PARM_2
      00034D 23               [12]  345 	rl	a
      00034E 54 01            [12]  346 	anl	a,#0x01
                                    347 ;	assignBit
      000350 24 FF            [12]  348 	add	a,#0xff
      000352 92 A1            [24]  349 	mov	_P2_1,c
                                    350 ;	./src/seven_segment.c:19: dat <<= 1;
      000354 E5 23            [12]  351 	mov	a,_sendbyte_PARM_2
      000356 25 E0            [12]  352 	add	a,acc
      000358 F5 23            [12]  353 	mov	_sendbyte_PARM_2,a
                                    354 ;	./src/seven_segment.c:20: CLK = 1;
                                    355 ;	assignBit
      00035A D2 A0            [12]  356 	setb	_P2_0
                                    357 ;	./src/seven_segment.c:15: for (i=0; i<8; i++)
      00035C 0F               [12]  358 	inc	r7
      00035D BF 08 00         [24]  359 	cjne	r7,#0x08,00131$
      000360                        360 00131$:
      000360 40 E7            [24]  361 	jc	00105$
                                    362 ;	./src/seven_segment.c:22: }
      000362 22               [24]  363 	ret
                                    364 ;------------------------------------------------------------
                                    ...
                                    374 ;	-----------------------------------------
      000363                        375 _Write7219:
      000363 AF 82            [24]  376 	mov	r7,dpl
                                    377 ;	./src/seven_segment.c:27: LOAD_MAX = 0;
                                    378 ;	assignBit
      000365 C2 A4            [12]  379 	clr	_P2_4
                                    380 ;	./src/seven_segment.c:28: for(cnt=1; cnt<=matrixnum; cnt++)
      000367 7E 01            [12]  381 	mov	r6,#0x01
      000369                        382 00102$:
                                    383 ;	./src/seven_segment.c:30: sendbyte(address, dat);
      000369 85 22 23         [24]  384 	mov	_sendbyte_PARM_2,_Write7219_PARM_2
      00036C 8F 82            [24]  385 	mov	dpl,r7
      00036E C0 07            [24]  386 	push	ar7
      000370 C0 06            [24]  387 	push	ar6
      000372 12 03 2C         [24]  388 	lcall	_sendbyte
      000375 D0 06            [24]  389 	pop	ar6
      000377 D0 07            [24]  390 	pop	ar7
                                    391 ;	./src/seven_segment.c:28: for(cnt=1; cnt<=matrixnum; cnt++)
      000379 0E               [12]  392 	inc	r6
      00037A EE               [12]  393 	mov	a,r6
      00037B 24 FE            [12]  394 	add	a,#0xff - 0x01
      00037D 50 EA            [24]  395 	jnc	00102$
                                    396 ;	./src/seven_segment.c:32: LOAD_MAX = 1;
                                    397 ;	assignBit
      00037F D2 A4            [12]  398 	setb	_P2_4
                                    399 ;	./src/seven_segment.c:33: }
      000381 22               [24]  400 	ret
                                    401 ;------------------------------------------------------------
      ...
      000382 75 22 01         [24]  412 	mov	_Write7219_PARM_2,#0x01
      000385 75 82 0C         [24]  413 	mov	dpl,#0x0c
      000388 12 03 63         [24]  414 	lcall	_Write7219
                                    415 ;	./src/seven_segment.c:39: Write7219(DISPLAY_TEST, 0x00);
      00038B 75 22 00         [24]  416 	mov	_Write7219_PARM_2,#0x00
      00038E 75 82 0F         [24]  417 	mov	dpl,#0x0f
      000391 12 03 63         [24]  418 	lcall	_Write7219
                                    419 ;	./src/seven_segment.c:40: Write7219(DECODE_MODE, 0x00);
      000394 75 22 00         [24]  420 	mov	_Write7219_PARM_2,#0x00
      000397 75 82 09         [24]  421 	mov	dpl,#0x09
      00039A 12 03 63         [24]  422 	lcall	_Write7219
                                    423 ;	./src/seven_segment.c:41: Write7219(SCAN_LIMIT, 0x07);
      00039D 75 22 07         [24]  424 	mov	_Write7219_PARM_2,#0x07
      0003A0 75 82 0B         [24]  425 	mov	dpl,#0x0b
      0003A3 12 03 63         [24]  426 	lcall	_Write7219
                                    427 ;	./src/seven_segment.c:42: Write7219(INTENSITY, 0x00);
      0003A6 75 22 00         [24]  428 	mov	_Write7219_PARM_2,#0x00
      0003A9 75 82 0A         [24]  429 	mov	dpl,#0x0a
      0003AC 12 03 63         [24]  430 	lcall	_Write7219
                                    431 ;	./src/seven_segment.c:44: for(i=1; i<=8; i++){
      0003AF 7F 01            [12]  432 	mov	r7,#0x01
      0003B1                        433 00102$:
                                    434 ;	./src/seven_segment.c:45: Write7219(i, 0x00);
      0003B1 75 22 00         [24]  435 	mov	_Write7219_PARM_2,#0x00
      0003B4 8F 82            [24]  436 	mov	dpl,r7
      0003B6 C0 07            [24]  437 	push	ar7
      0003B8 12 03 63         [24]  438 	lcall	_Write7219
      0003BB D0 07            [24]  439 	pop	ar7
                                    440 ;	./src/seven_segment.c:44: for(i=1; i<=8; i++){
      0003BD 0F               [12]  441 	inc	r7
      0003BE EF               [12]  442 	mov	a,r7
      0003BF 24 F7            [12]  443 	add	a,#0xff - 0x08
      0003C1 50 EE            [24]  444 	jnc	00102$
                                    445 ;	./src/seven_segment.c:47: }
      0003C3 22               [24]  446 	ret
                                    447 	.area CSEG    (CODE)
                                    448 	.area CONST   (CODE)
                                    449 	.area XINIT   (CODE)
